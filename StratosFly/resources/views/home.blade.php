...
<section style="background-image: url('/images/ai_avion.webp'); background-size: cover; background-position: center; background-repeat: no-repeat; witdh: 1512px; height:661px">
...
<section>
     <div class="container-fluid custom-color py-5">
        <div class="row d-flex justify-content-evenly align-items-center">
            ...
            <div class="col-sm-5 fw-bold py-5 text-center">
